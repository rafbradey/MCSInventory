    ...
    <div class="container settings-container bg-light p-4 shadow rounded-lg w-50 text-center">
      @if (auth()->user()->usertype === 'admin')
        ...
        <div class="row d-flex flex-wrap justify-content-center align-items-stretch">
          <a href="password"type="button" class="btn btn-primary btn-lg m-2">Change Phone Number</a>
          <p class="text-muted w-100">Update your registered phone number for account security and verification.</p>
          <a type="button" class="btn btn-primary btn-lg m-2">Reset Password</button>
      ...
      @else
        ...
        <div class="row d-flex flex-wrap justify-content-center align-items-stretch">
          ...
          <p class="text-muted w-100">Secure your account by changing your password regularly.</p>
          <a type="button" class="btn btn-primary btn-lg m-2">Request Email Change</a>
        ...
        @else
          <a href = "email/verify" type="button" class="btn btn-primary btn-lg mt-4">Verify Email Address</a>
          <p class="text-muted">Click the button to verify your email address.</p>
        @endif
