...
<div class="container mt-4">
    ...
    <p class="text-center">Editing details for ID: {{$Inventory->id}} - {{ $Inventory->school_property }}</p>
    ...
    <form action="{{ url('updateInventory/'.$Inventory->id) }}" method="POST" class="mx-auto">
        @csrf
        @method('PUT')
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="school_property" name="school_property" value="{{ $Inventory->school_property }}">
                </div>

                <div class="mb-3">
                    <label for="property_number" class="form-label">Property Number</label>
                    <input type="text" class="form-control" id="property_number" name="property_number" value="{{ $Inventory->property_number }}">
                </div>

                <div class="mb-3">
                    <label for="unit_of_measure" class="form-label">Unit of Measure</label>
                    <input type="text" class="form-control" id="unit_of_measure" name="unit_of_measure" value="{{ $Inventory->unit_of_measure }}">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="remarks" name="remarks" value="{{ $Inventory->remarks }}">
                </div>

                <div class="mb-3">
                    <label for="category" class="form-label">Category</label>
                    <input type="text" class="form-control" id="category" name="category" value="{{ $Inventory->category }}">
                </div>

                <div class="mb-3">
                    <label for="acquisition_type" class="form-label">Acquisition Type</label>
                    <input type="text" class="form-control" id="acquisition_type" name="acquisition_type" value="{{ $Inventory->acquisition_type }}">
                </div>

                <div class="mb-3">
                    <label for="grade_level" class="form-label">Grade Level</label>
                    <input type="text" class="form-control" id="grade_level" name="grade_level" value="{{ $Inventory->grade_level }}">
                </div>
            </div>
        </div>
