      ...
      <div class="sidebar" id="side_nav">
        ...
        <div class="header-box px-2 pt-3 pb-4 d-flex justify-content-between">
          ...
          <ul class="list-unstyled px-2">
            ...
            <li class="{{ request()->routeIs('inventory') ? 'active' : '' }}"><a href="{{route('inventory')}}" class="text-decoration-none px-3 py-2 d-block d-flex justify-content-between">
          ...
          <li class="{{ request()->routeIs('requestPage') ? 'active' : '' }}">
            <a href="{{ route('requestPage') }}" class="text-decoration-none px-3 py-2 d-block">
          ...
          <ul class="list-unstyled px-2">
              <li class="{{ request()->routeIs('settings') ? 'active' : '' }}"><a href="{{route('settings')}}" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid ms-2 fa-gear"></i> Settings</a></li>
              <li class="{{ request()->routeIs('logout') ? 'active' : '' }}"><a href="{{route('logout')}}" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid ms-2 fa-right-from-bracket"></i>Logout</a></li>
